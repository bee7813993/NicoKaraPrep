...
/// <summary>
/// アプリ全体の設定（%APPDATA%\TimeTagTool\settings.json に保存）。
/// </summary>
public sealed class AppSettings
{
    ...
    public static string DefaultPath =>
        Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "TimeTagTool", "settings.json");
